...
Intel Xeon Phi series of accelerators has been discontinued in 2020, and
most supercomputers using it are now retired. The support for Xeon Phi
is deprecated in GROMACS 2024 and will be
...
to `gmx grompp`. The convenience of this mdrun option was outweighed by
