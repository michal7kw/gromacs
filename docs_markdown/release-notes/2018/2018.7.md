...
since version 2018.6, to fix known issues. It also incorporates all
fixes made in previous versions, which you can find described in the
`release-notes`.
...
A `fix <release-notes-2018-6-gpu>` made to GPU kernels in 2018.6 was
