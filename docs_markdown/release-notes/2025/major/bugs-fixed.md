...
The dispersion correction of the test particle with the system was
double counted.
...
`gmx grompp` merges molecule blocks in the topology with the same
molecule type. With TPI this prevented insertion of a molecule into a
liquid of the same molecules.
