...
prepare for such changes, and contact the
GROMACS developers to see how they might be
affected and how best to adapt.

There is a current list of anticipated changes and deprecated
functionality in the "Major release" `notes <release-notes>`.
